...
<link rel="icon" type="image/ico" href="http://tattek.com/minimal/assets/images/favicon.ico" />
	...
	<style type="text/css">
	  .fa-baoxian:before{
		   content:url(${ctx }/img/baoxian.png);
	    width:80px;
	    height:80px;
	    z-index: 100;
	    top: -110px;  
	  ...
	  .fa-guifei:before{
		   content:url(${ctx }/img/guifei.png);
	    width:80px;
	    height:80px;
	    z-index: 100;
	    top: -110px;  
	  ...
	  .fa-baoyang:before{
		   content:url(${ctx }/img/baoyang.png);
	    width:80px;
	    height:80px;
	    z-index: 100;
	    top: -110px;  
	  ...
	  .fa-nianjian:before{
		   content:url(${ctx }/img/nianjian.png);
	    width:80px;
	    height:80px;
	    z-index: 100;
	    top: -110px;  
	                  ...
	                  <div class="front"> 
	                    <div class="media">        
	                      <span class="pull-left">
	                        <i class="fa fa-baoyang media-object"></i>
	                      </span>
	              ...
	              <div class="card-container col-lg-3 col-sm-3 ">
	                <div class="card card-blue hover">
	                  <div class="front">        
	                    ...
	                    <div class="media">                  
	                      <span class="pull-left">
	                        <i class="fa fa-nianjian media-object"></i>
	                      </span>
	              ...
	              <div class="card-container col-lg-3 col-sm-3 ">
	                <div class="card card-greensea hover">
	                  <div class="front">        
	                    ...
	                    <div class="media">
	                      <span class="pull-left">
	                        <i class="fa fa-guifei media-object"></i>
	                      </span>
	              ...
	              <div class="card-container col-lg-3 col-sm-3 col-xs-3">
	                <div class="card card-slategray hover">
	                  <div class="front"> 
	                    ...
	                    <div class="media">                   
	                      <span class="pull-left">
	                        <i class="fa fa-baoxian media-object"></i>
	                      </span>
					 ...
					 <!-- 排行榜 -->
					    <section class="tile transparent recent-activity">
			                  ...
			                  <div class="tile-widget color transparent-black rounded-top-corners nopadding">
			                    ...
			                    <ul class="nav nav-tabs tabdrop">
			                      <c:forEach items="${topList }" var="top">
			                         <c:if test="${top.actionFlag}" var="hactive">
			                          	<li class="active" ><a href="#${top.tabId }" data-toggle="tab">${top.tabName}</a></li>
			                         </c:if>
			                        
			                         <c:if test="${not  hactive}">
			                            <li ><a href="#${top.tabId }" data-toggle="tab">${top.tabName}</a></li>
			                         </c:if>
			                      </c:forEach>
			                    </ul>
			                    <!-- / Nav tabs -->
			                  ...
			                  <div class="tile-body tab-content nopadding rounded-bottom-corners">
			                    <!-- Tab panes -->
			                    <c:forEach items="${topList }" var="top" varStatus="topIndex" >
			                       <c:if test="${top.actionFlag}" var="tflag">
					                  <ul id="${top.tabId }" class="tab-pane fade in active" >
					                    <c:forEach items="${top.rankRowList }" var="rankRow" varStatus="rowIndex">
						                      <li>
						                        <img src="${ctx}${rankRow.seqImgPath}${rowIndex.index+1}.png" class="w35">
						                        <span class="user font-slab"><strong>${rankRow.display }</strong></span>
						                        <span class="subject"> <strong>${rankRow.belongDepName }</strong></span>
						                        <span class="time">${rankRow.displayCount }</span>
						                      </li>
					                      </c:forEach>
					                   </ul>
					               </c:if>
					               <c:if test="${not  tflag}">
			                            <ul id="${top.tabId }" class="tab-pane fade " >
			                              <c:forEach items="${top.rankRowList }" var="rankRow" varStatus="rowIndex">
						                      <li>
						                        <img src="${ctx}${rankRow.seqImgPath}${rowIndex.index+1}.png" class="w35">
						                        <span class="user font-slab"><strong>${rankRow.display }</strong></span>
