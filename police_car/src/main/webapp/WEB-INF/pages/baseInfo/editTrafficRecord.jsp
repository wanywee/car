						...
						<div class="col-xs-12">
							...
							<form class="form-horizontal" role="form" id="form">
								<div class="row">
									<div class="form-group col-xs-6">
										<label class="col-xs-3 control-label no-padding-right"
											for="time">时间:</label>
										<div class="col-xs-9">
											<input id="time" name="time" class="validate[required]"
												value="${recodeDo.time}" />
										</div>
									</div>
								...
								<div class="row">
									<div class="form-group col-xs-6">
										<label class="col-xs-3 control-label no-padding-right"
											for="context">情况概述:</label>

										<div class="col-xs-9">
											<textarea id="context" name="context" class="validate[required,maxSize[128]]"
												class="autosize-transition form-control">${recodeDo.context}</textarea>
										</div>
									</div>
								...
								<div class="row">
									<div class="form-group col-xs-6">
										<label class="col-xs-3 control-label no-padding-right"
											for="conditions">处理情况:</label>

										<div class="col-xs-9">
											<textarea id="conditions" name="conditions" class="validate[required,maxSize[128]]" class="autosize-transition form-control"
												>${recodeDo.conditions}</textarea>
										</div>
									</div>
