						...
						<div class="col-xs-12">
							...
							<form class="form-horizontal" role="form" id="form">
								<div class="row">
									<div class="form-group col-xs-6">
										<label class="col-xs-3 control-label no-padding-right"
											for="original">原部门:</label>

										<div class="col-xs-9">
											<input id="original" name="original"
												class="validate[required,maxSize[12]]" value="${recodeDo.original}"></textarea>
										</div>
									</div>
								...
								<div class="row">
									<div class="form-group col-xs-6">
										<label class="col-xs-3 control-label no-padding-right"
											for="reception">接收部门:</label>

										<div class="col-xs-9">
											<input id="reception" name="reception"
												class="validate[required,maxSize[12]]" value="${recodeDo.reception}"></input>
										</div>
									</div>
								...
								<div class="row">
									<div class="form-group col-xs-6">
										<label class="col-xs-3 control-label no-padding-right"
											for="changeTime">变更时间:</label>
										<div class="col-xs-9">
											<input id="changeTime" name="changeTime" class="validate[required]"
												value="${recodeDo.changeTime}" />
										</div>
									</div>
