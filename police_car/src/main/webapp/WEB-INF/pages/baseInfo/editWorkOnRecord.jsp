						...
						<div class="col-xs-12">
							...
							<form class="form-horizontal" role="form" id="form">
								<div class="row">
									<div class="form-group col-xs-6">
										<label class="col-xs-3 control-label no-padding-right"
											for="traniningTime">时间:</label>
										<div class="col-xs-9">
											<input id="traniningTime" name="traniningTime" class="validate[required]"
												value="${recodeDo.traniningTime}" />
										</div>
									</div>
								...
								<div class="row">
									<div class="form-group col-xs-6">
										<label class="col-xs-3 control-label no-padding-right"
											for="content">培训内容:</label>

										<div class="col-xs-9">
											<textarea id="content" name="content" class="validate[required,maxSize[256]]"
												class="autosize-transition form-control">${recodeDo.content}</textarea>
										</div>
									</div>
