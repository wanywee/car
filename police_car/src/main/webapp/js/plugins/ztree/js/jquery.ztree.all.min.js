...
(function(q) {
    ...
    i = {
        ...
        makeDOMNodeIcon: function(b, a, c) {
            ...
            b.push("<span id='", c.tId, f.id.ICON, "' title='' treeNode", f.id.ICON, " class='", i.makeNodeIcoClass(a, c), "' style='", i.makeNodeIcoStyle(a, c), "'></span>");
            //自定义iconClass
            if(c.iconClass != null){
				b.push("<span id='iconClass_"+c.id+"' class='"+c.iconClass+"'></span>");
			}
            b.push("<span id='", c.tId, f.id.SPAN, "' class='", f.className.NAME, "'>", d, "</span>")
        },
