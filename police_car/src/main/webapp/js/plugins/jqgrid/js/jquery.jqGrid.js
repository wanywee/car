        ...
        return this.each(function() {
            if (!this.grid) {
                ...
                z = function(a, b, c, f, g, h) {
                    ...
                    p.length || (p[0] = "", m += '"'),
                    m += (void 0 !== n ? ' class="' + n + '"': "") + (k.title && c ? ' title="' + (o == "opt" ? "" : $.jgrid.stripHtml(c)) + '"': ""),//自定义修改，操作列不加title
                ...
                R = function(a) {
                    if (!d.grid.hDiv.loading) {
                        ...
                        case "script":
                            $.ajax($.extend({
                                url:
                                d.p.url + (d.p.ignoreCount ? ((d.p.url.indexOf("?") > 0 ? "&" : "?") + "ignoreCount=" + d.p.ignoreCount) : ""),
                                type: d.p.mtype,
                                dataType: b,
                ...
                T = function(a, b) {
                    ...
                    if ("rtl" === h && (s += t), d.p.pginput === !0 && (r = "<td id='input" + b + "' dir='" + h + "'>" + $.jgrid.template($.jgrid.getRegional(d, "defaults.pgtext", d.p.pgtext) || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(a) + "'></span>") + "</td>"), d.p.pgbuttons === !0) {
                        var w = ["first" + b, "prev" + b, "next" + b, "last" + b, "refresh" + b],
                        x = k(l, "pgButtonBox", !0, "ui-pg-button"),
                        z = [$.jgrid.getRegional(d, "defaults.pgfirst", d.p.pgfirst) || "", $.jgrid.getRegional(d, "defaults.pgprev", d.p.pgprev) || "", $.jgrid.getRegional(d, "defaults.pgnext", d.p.pgnext) || "", $.jgrid.getRegional(d, "defaults.pglast", d.p.pglast) || "", $.jgrid.getRegional(d, "defaults.pgrefresh", d.p.pgfirst) || ""];
                        ...
                        s += "<td id='" + w[4] + "' class='" + x + "' title='" + z[4] + "'><span " + k(l, "icon_refresh", !1, q) + "></span></td>"
                    } else "" !== r && (s += r);
                    "ltr" === h && (s += t),
                    s += "</tr></tbody></table>",
                    ...
                    function() {
                    ...
                    }), $("#first" + $.jgrid.jqID(b) + ", #prev" + $.jgrid.jqID(b) + ", #next" + $.jgrid.jqID(b) + ", #last" + $.jgrid.jqID(b) + ", #refresh" + $.jgrid.jqID(b)).click(function() {
                        ...
                        u(this.id.split("_")[0], this) ? (this.id === "first" + b && f && (d.p.page = 1, e = !0), this.id === "prev" + b && g && (d.p.page = a - 1, e = !0), this.id === "next" + b && h && (d.p.page = a + 1, e = !0), this.id === "last" + b && i && (d.p.page = c, e = !0), this.id === "refresh" + b && j && (d.p.page = a, e = !0), e && R(), !1) : !1
                    })),
                ...
                if (d.p.disableClick = !1, $("th", sb).each(function(a) {
                    ...
                    "boolean" != typeof kb && (d.p.colModel[a].sortable = !1, kb = !1);
                    ...
                    //不能排序的列去掉样式
                    if(!kb){
                    	$(">div", this).removeClass("ui-jqgrid-sortable");
                    }
                ...
                (!$.jgrid.isMobile() ? $(".ui-jqgrid-view").css("width", (d.p.tblwidth + 1) + "px") : 1),//Modified 解决自适应宽度后始终出现的滚动条
                $(".ui-jqgrid-hdiv").css("width", d.p.tblwidth + "px"),//Modified 浏览器大小变化时标题栏自适应宽度
...
//                $(this).navGrid(c.pager);//自定义修改，默认显示刷新按钮
            }
        })
    },
    $.jgrid.extend({
            ...
            return this.each(function() {
                if (this.grid) {
                    ...
                    if ("boolean" != typeof b && (b = g.p.shrinkToFit), !isNaN(a)) {
                        ...
                        (!$.jgrid.isMobile() ? $(".ui-jqgrid-view").css("width", (g.p.tblwidth + 1) + "px") : 1),//Modified 解决自适应宽度后始终出现的滚动条
                        $(".ui-jqgrid-hdiv").css("width", g.p.tblwidth + "px");//Modified 浏览器大小变化时标题栏自适应宽度
...
$(window).bind("resize", function() {
    ...
    $(".jqGrid_wrapper table").setGridWidth(width);
});