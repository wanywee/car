...
public class VehicleRS extends com.stopec.common.orm.BasicDO {
	private static final long serialVersionUID = 1L;
	/** ID */
	private Integer id;
	/** 车牌号 */
	@Validate(rule = "{required}", regexp = "^[京津沪渝冀豫云辽黑湘皖鲁新苏浙赣鄂桂甘晋蒙陕吉闽贵粤青藏川宁琼使领A-Z]{1}[A-Z]{1}-[A-Z0-9]{4}[A-Z0-9挂学警港澳]{1}$", comment = "车牌号")
	private String licenseno;
	/** 载重 */
	@Validate(rule = "{required,min[0]}", regexp="^?\\d+(\\.\\d+)?$", comment="车辆载重")
	...
	public VehicleRS clone() {
		try {
			return (VehicleRS) super.clone();
